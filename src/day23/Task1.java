...
public class Task1 {
    ...
    /*
    1. ArrayList is index based, where HashSet is not
    2. HashSet doesn't guaranty the order of elements
    3. HashSet doesn't allow duplicates
    4. There is not get method in HashSet :/
     */
