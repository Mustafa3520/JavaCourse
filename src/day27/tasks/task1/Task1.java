...
//        System.out.println(student3.name + ": " + student3.grade);
    ...
    public static Student createStudent(String names, double grades) { // another name for this method studentGenerator
    ...
    // create a method that will get an average of students grade
